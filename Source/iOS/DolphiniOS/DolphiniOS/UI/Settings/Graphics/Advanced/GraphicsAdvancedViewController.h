...
@property (weak, nonatomic) IBOutlet DOLSwitch *m_wireframe_switch;
@property (weak, nonatomic) IBOutlet DOLSwitch *m_statistics_switch;
@property (weak, nonatomic) IBOutlet DOLSwitch *m_format_overlay_switch;
@property (weak, nonatomic) IBOutlet DOLSwitch *m_enable_api_validation_switch;
@property (weak, nonatomic) IBOutlet DOLSwitch *m_dump_textures_switch;
@property (weak, nonatomic) IBOutlet DOLSwitch *m_load_custom_textures_switch;
@property (weak, nonatomic) IBOutlet DOLSwitch *m_prefetch_custom_textures_switch;
@property (weak, nonatomic) IBOutlet DOLSwitch *m_dump_efb_target_switch;
@property (weak, nonatomic) IBOutlet DOLSwitch *m_disable_vram_copies_switch;
@property (weak, nonatomic) IBOutlet DOLSwitch *m_crop_switch;
@property (weak, nonatomic) IBOutlet DOLSwitch *m_progressive_scan_switch;
@property (weak, nonatomic) IBOutlet DOLSwitch *m_backend_multithreading_switch;
@property (weak, nonatomic) IBOutlet DOLSwitch *m_defer_efb_switch;
