...
@property (weak, nonatomic) IBOutlet DOLSwitch* m_vsync_switch;
@property (weak, nonatomic) IBOutlet DOLSwitch* m_fps_switch;
@property (weak, nonatomic) IBOutlet DOLSwitch* m_netplay_messages_switch;
@property (weak, nonatomic) IBOutlet DOLSwitch* m_render_time_log_switch;
@property (weak, nonatomic) IBOutlet DOLSwitch* m_netplay_ping_switch;
@property (weak, nonatomic) IBOutlet DOLSwitch* m_compile_shaders_switch;
