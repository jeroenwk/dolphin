...
ROOT_SRC_DIR="$PROJECT_DIR/Common"
...
do
  ...
  sed "s/FILENAME/$FILENAME/g" "$ROOT_SRC_DIR/Build Resources/DolphinImageTemplate.json.in" > "$ROOT_SRC_DIR/DolphinImages.xcassets/$FILENAME.imageset/Contents.json"
done
